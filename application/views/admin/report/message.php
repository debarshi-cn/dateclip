<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<ol class="breadcrumb">
		...
		<li class="active">Flagged Masseges</li>
	</ol>

	<h1 class="page-header"><span class="glyphicon glyphicon-inbox"></span> Flagged Masseges</h1>
	...
	<form class="form-horizontal" role="form" method="post">
		<div class="panel panel-default inner-spacer" >
			<div class="form-group">
			    <div class="col-md-12">
				  	<h2><small><span class="glyphicon glyphicon-search"></span> Search Flagged Masseges</small></h2>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			    <div class="col-sm-offset-1 col-sm-11">
			    	...
			    	<a class="btn btn-default" href="<?php echo HTTP_ADMIN_PATH; ?>report/message/reset">Reset</a>
			    </div>
			</div>
		</div>
	</form>
		    ...
		    <table class="table table-striped table-hover">
		        ...
		        <tbody>
		            ...
		            <tr>
		            	...
		            	<td><?php echo character_limiter($row->message,20);?></td>
		            	<td>
		            	<?php
		            	...
		            	<td>
		            		<a class="btn btn-info btn-xs userModalButton" href="#" data-src="<?php echo HTTP_ADMIN_PATH; ?>users/details/<?php echo $row->message_id;?>" data-toggle="modal" data-target="#userDetailsModal">
		            			<span class="glyphicon glyphicon-edit"></span> View Message
		            		</a>
		            	</td>
		            </tr>
		            <?php } ?>
