<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<h1 class="page-header"><span class="glyphicon glyphicon-user"></span> Add User</h1>
		...
		<div class="form-group has-feedback">
	  		...
	  		<input type="text" name="date_of_birth" class="form-control calender-control" id="inputDOB" placeholder="Date of birth"> <span class="form-control-feedback glyphicon glyphicon-calendar"></span>
	  	</div>
