<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<h1 class="page-header"><span class="glyphicon glyphicon-lock"></span> Update Profile</h1>
		...
		<?php
			...
			echo form_open(HTTP_ADMIN_PATH.'home/update/', $attributes);
      	?>
	  	...
	  	<h2><small><span class="glyphicon glyphicon-certificate"></span> Update Password <small>[ All the 3 fields are required for updating password. ]</small></small></h2>
